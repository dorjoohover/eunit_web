...
import { CloseIcon, SearchIcon } from "../global/icons";
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 w-screen md:hidden bg-mainBlossom">
        <div className="flex flex-row">
          ...
          <Container
            ...
            text="Хэтэвч"
            Icon={(props: any) => <IoWallet {...props} />}
          />
          <Container
            onClick={() => setSearch(true)}
            text="Хайлт"
            Icon={(props: any) => <BiSearch {...props} />}
          />
          <Container
            onClick={() => handleLink("/estimator")}
            text="Үнэлгээ"
            Icon={(props: any) => <AiFillCalculator {...props} />}
          />
          <Container
            text="Профайл"
            onClick={() => handleLink("/account")}
            Icon={(props: any) => <FaUserCircle {...props} />}
          />
        </div>
        <div
